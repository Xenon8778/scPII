...
class scPRS:
    def __init__(self, X, gene_names=None, Corr_cutoff=0, alpha=1, getPval=True,
                 cluster=True, Kclusters=10, n_comps=50, use_GC=True,
                 weighted=False, explainedV=1, n_boot=10000, n_jobs=1,
                 verbose=True):
        self.X = X
        self.gene_names = gene_names
        self.Corr_cutoff = Corr_cutoff
        self.alpha = alpha
        self.getPval = getPval
        self.cluster = cluster
        self.Kclusters = Kclusters
        self.n_comps = n_comps
        self.use_GC = use_GC
        self.weighted = weighted
        self.explainedV = explainedV
        self.n_boot = n_boot
        self.n_jobs = n_jobs
